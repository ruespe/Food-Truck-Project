...
function submit() {
    if (editId.value) {
        form.patch(`/admin/locations/${editId.value}`, {
            onSuccess: () => {
...
<template>
    ...
    <div
        v-if="showForm"
        class="mb-6 grid gap-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm lg:grid-cols-2 dark:border-[#66c0f4]/50 dark:bg-slate-800"
    >
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        readonly
                        class="w-full rounded-xl border border-slate-200 bg-slate-100 px-3 py-2 text-sm text-slate-600 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-300"
                    />
                </div>
                <div>
                    <label class="text-xs text-slate-500 dark:text-slate-400"
                ...
                >
                    ...
                    >
                        ...
                        <td
                            class="px-6 py-4 text-slate-600 dark:text-slate-300"
                        >
                            {{ loc.start_time.slice(0, 5) }} –
                            {{ loc.end_time.slice(0, 5) }}
                        </td>
