...
<template>
    ...
    <!-- Filters -->
    <div
        class="mb-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-[#66c0f4]/50 dark:bg-slate-800"
    >
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                >
                    ...
                    >
                        <td
                            class="px-6 py-4 font-mono text-xs text-amber-500 dark:text-amber-400"
                        >
                            {{ order.ref }}
                        </td>
                        <td class="px-6 py-4">
