...
<template>
    ...
    >
        ...
        >
            ...
            <a href="/login" class="ml-2 underline hover:text-red-100">{{ t('nav.login') }}</a>
        </div>
    </Transition>
            ...
            >
                <div class="relative flex h-44 items-center justify-center bg-amber-100 dark:bg-amber-900/30">
                    <CloudinaryImage
                        ...
                        :class="!product.stock ? 'brightness-50 saturate-0' : ''"
                        sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                    />
                    <span v-else class="flex items-center justify-center" :class="!product.stock ? 'opacity-30' : ''"><ImagePlaceholder class="h-14 w-14 text-amber-300 dark:text-amber-700" /></span>
                    <!-- Overlay + badge sin stock -->
                    <div v-if="!product.stock" class="absolute inset-0 flex flex-col items-center justify-center bg-red-600/40">
                ...
                <div class="p-4">
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        ...
                        <span v-else-if="!product.stock" class="text-sm font-semibold text-red-400">{{ t('menu.outOfStock') }}</span>
