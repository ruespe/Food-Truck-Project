...
<head>
    ...
    <style>
        ...
        .header { background: #16a34a; padding: 32px; text-align: center; color: #ffffff; }
        .header h1 { margin: 8px 0 0; font-size: 24px; }
        .header p { margin: 8px 0 0; font-size: 14px; opacity: .85; }
        .body { padding: 32px; }
        .order-num { font-size: 20px; font-weight: bold; color: #15803d; margin-bottom: 16px; }
        .ready-badge { display: inline-block; background: #dcfce7; color: #15803d; border: 1px solid #bbf7d0; border-radius: 8px; padding: 12px 20px; font-size: 16px; font-weight: bold; margin-bottom: 24px; }
        ...
        .location-box { background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 10px; padding: 18px 20px; margin-top: 24px; }
        .location-box h3 { margin: 0 0 8px; font-size: 15px; color: #14532d; }
        .location-box p { margin: 4px 0 0; font-size: 14px; color: #166534; }
